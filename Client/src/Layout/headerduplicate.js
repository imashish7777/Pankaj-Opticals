    ...
    <>
      ...
      <header className="header-upper py-1 ">
        <div className="container-fluid">
          <div className="row align-items-center header-parts">
            <div className="col-12 col-sm-2 header-part1">
              <Link to="/" className="header-logo">
                <img src="https://res.cloudinary.com/pankajoptical/image/upload/v1709921004/pankajoptical_LOGO_ielprm.png" />
              </Link>
            </div>
            <div className="col-sm-2 col-1"></div>
            <div className="col-sm-5 col-10 d-flex  header-part2">
              <Input.Group compact>
                <AutoComplete
                  style={{
                    width: "90%",
            ...
            <div className="col-sm-3 pt-3 mr-5">
              <div className="header-upper-links d-flex  align-items-center justify-content-between">
                ...
                <Link
                  to="/cart"
                  className=" position-relative d-flex align-items-center  text-black"
                >
